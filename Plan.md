...
4. Заполнение поля номером менее 16 цифр, например 1234 1234 1234 1234 123. **Ожидаемый результат:** ограничение ввода большего числа цифр
...
8. Заполнение поля с использованием двойной фамилии с дефисом, например "Kuzma Petrov-Vodkin". **Ожидаемый результат:** запрет ввода дефиса
##### Поле "CVC/CVV"
1. Незаполненное поле. **Ожидаемый результат:** появление под полем надписи "Поле обязательно для заполнения"
